...
var (
	filter_Server_GetData_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
)

func request_Server_GetData_0(ctx context.Context, marshaler runtime.Marshaler, client ServerClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq GetDataRequest
	var metadata runtime.ServerMetadata

	if err := runtime.PopulateQueryParameters(&protoReq, req.URL.Query(), filter_Server_GetData_0); err != nil {
...
func RegisterServerHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ServerClient) error {
	...
	mux.Handle("GET", pattern_Server_GetData_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Server_GetData_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_Server_GetData_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_Server_GetData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0}, []string{"data"}, ""))
)

var (
	forward_Server_GetData_0 = runtime.ForwardResponseMessage
)
